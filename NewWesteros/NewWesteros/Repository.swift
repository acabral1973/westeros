...
final class LocalFactory : WesterosFactory{
    ...
    var seasons: [Season]{
        get{
            ...
            let episode1season1 = Episode(name: "1: \"Winter Is Coming\"", date: "17/04/2011".toDate(), season: season1)
            let episode2season1 = Episode(name: "2: \"The Kingsroad\"", date: "24/04/2011".toDate(), season: season1)
            let episode1season2 = Episode(name: "1: \"The North Remembers\"", date: "01/04/2012".toDate(), season: season2)
            let episode2season2 = Episode(name: "2: \"The Night Lands\"", date: "08/04/2012".toDate(), season: season2)
            let episode1season3 = Episode(name: "1: \"Valar Dohaeris\"", date: "31/03/2013".toDate(), season: season3)
            let episode2season3 = Episode(name: "2: \"Dark Wings, Dark Words\"", date: "07/04/2013".toDate(), season: season3)
            let episode1season4 = Episode(name: "1: \"Two Swords\"", date: "06/04/2014".toDate(), season: season4)
            let episode2season4 = Episode(name: "2: \"The Lion and the Rose\"", date: "13/04/2014".toDate(), season: season4)
            let episode1season5 = Episode(name: "1: \"The Wars to Come\"", date: "12/04/2015".toDate(), season: season5)
            let episode2season5 = Episode(name: "2: \"The House of Black and White\"", date: "19/04/2015".toDate(), season: season5)
            let episode1season6 = Episode(name: "1: \"The Red Woman\"", date: "24/04/2016".toDate(), season: season6)
            let episode2season6 = Episode(name: "2: \"Home\"", date: "01/05/2016".toDate(), season: season6)
